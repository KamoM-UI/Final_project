...
import 'package:tello_app/insight%20screens/body3.dart';
import 'package:tello_app/screens/details_screen2.dart';
import 'package:tello_app/screens/home_page.dart';
import 'package:tello_app/spinach%20screens/steps_screen10.dart';
import 'package:tello_app/spinach%20screens/steps_screen11.dart';
import 'package:tello_app/spinach%20screens/steps_screen12.dart';
import 'package:tello_app/spinach%20screens/steps_screen9.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
                ...
                children: [
                  Expanded(
                    child: Column(
                      children: [
                        Text(
                          'Spinach is a leafy green vegetable known for its high nutritional value. It\'s rich in iron, vitamins A, C, and K, and antioxidants. Spinach can be eaten raw in salads or cooked in soups, stews, and sautés. It grows best in cool weather, well-drained soil, and needs regular watering. It is a fast-growing plant and can be harvested multiple times.',
                          maxLines: 5,
                          style: GoogleFonts.quicksand(
                            fontWeight: FontWeight.bold,
                            fontSize: 10,
        ...
        Image.asset('assets/images/ai-generated-spinach-studio-shot-isolated-on-transparent-background-food-photography-png.webp', height: 120),
      ],
    );
  }
}
